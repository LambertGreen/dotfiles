...
echo "     mkdir -p package-management/machines/<form_factor>_<purpose>_<os>"
echo "  3. Copy the relevant package manager directories:"
echo "     cp -r ${EXPORT_DIR}/* package-management/machines/<your_machine_class>/"
echo ""
print_info "Example:"
echo "  mkdir -p package-management/machines/laptop_work_mac"
echo "  cp -r ${EXPORT_DIR}/* package-management/machines/laptop_work_mac/"