...
* Issues
** Issue: =Sub-modules= sometimes are not updated and need manual intervention
...
*** TODO Add application install steps/scripts
**** Description
...
*Update*: Well, I have gone full circle, and found that the bulk install is a good option after all. *shrug*
